...
namespace E_Gandhal.src.Presentation.Controllers.StudentController
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCountStudent(CancellationToken cancellationToken)
        {
            var count = await _studentRepository.CountStudentsAsync(cancellationToken);
